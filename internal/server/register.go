...
func writePrepareShell(w http.ResponseWriter, status int, value PrepareResponse) {
	...
	fmt.Fprintf(w, "WG_SERVER_IPV6_ADDR_B64=%s\n", shellB64(value.Node.WGServerIPv6Address))
	fmt.Fprintf(w, "WG_CLIENT_IPV6_ADDR_B64=%s\n", shellB64(value.Node.WGClientIPv6Address))
	fmt.Fprintf(w, "WG_WARP_CLIENT_ADDR_B64=%s\n", shellB64(value.Node.WGWarpClientAddress))
	fmt.Fprintf(w, "WG_WARP_CLIENT_IPV6_ADDR_B64=%s\n", shellB64(value.Node.WGWarpClientIPv6Address))
